const TRANSLATIONS = {
  pt: {
    ...
    "admin.login.errorMfaCode": "Digite o código de verificação.",
    "admin.login.errorMfaExpired": "Sessão de verificação expirada. Faça login novamente.",
    "admin.login.errorMfaInvalid": "Código inválido.",
  ...
  en: {
    ...
    "admin.login.errorMfaCode": "Enter the verification code.",
    "admin.login.errorMfaExpired": "Verification session expired. Please log in again.",
    "admin.login.errorMfaInvalid": "Invalid code.",
    "admin.nav.dashboard": "Dashboard",
